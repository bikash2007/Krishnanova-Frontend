...
import { FaLock, FaBolt, FaUndo, FaShoppingCart } from "react-icons/fa";
    ...
    >
      <div className="backdrop-blur-xl bg-white/5 rounded-3xl p-12 border border-white/10 shadow-2xl">
        ...
        <p className="text-blue-100/60 mb-8 leading-relaxed">
          The path to divine connection begins with a single step. Explore our
          sacred collection.
        </p>
          ...
          <div className="flex-1 space-y-6">
            <div className="flex items-center justify-between mb-2">
              <h1 className="text-3xl md:text-4xl font-serif text-white">
                Your Cart{" "}
                <span className="text-amber-300 text-lg md:text-xl font-sans ml-2">
                  ({totalItems} items)
                </span>
              </h1>
              <button
                ...
                {cart.map((item, index) => (
                  <CartItem
                    ...
                    onUpdateQuantity={(id, qty) =>
                      qty <= 0 ? removeFromCart(id) : updateQuantity(id, qty)
                    }
          ...
          <div className="lg:w-96 shrink-0">
            <div className="sticky top-28">
              <div className="backdrop-blur-xl bg-white/5 rounded-3xl p-6 md:p-8 border border-white/10 shadow-2xl">
                ...
                <Link
                  to="/productpage"
                  className="block text-center text-sm text-blue-200/60 hover:text-white transition-colors"
                >
